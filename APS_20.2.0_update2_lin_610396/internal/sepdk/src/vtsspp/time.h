...
{
    if (vtss_time_source == VTSS_TIME_SOURCE_SYS) {
...
static inline void vtss_rdtsc_barrier(void) __attribute__ ((always_inline));
static inline void vtss_rdtsc_barrier(void)
{
...
static inline unsigned long long vtss_time_get_msec_from(unsigned long long cputsc)
{
