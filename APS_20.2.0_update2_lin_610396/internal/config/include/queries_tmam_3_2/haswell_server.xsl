            ...
            <queryLibrary>
                ...
                <derivedQuery displayName="%FBFull" id="FBFull">
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <issueEval>
                                <![CDATA[ ( ( ( query("/FBFull") > 0.3 ) || ( queryOptional("/SQFull") > 0.3) || ( queryOptional("/StoreLatency") > 0.1) ) && ( ( ( ( query("/L1Bound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) || ( queryOptional("/DTLBOverhead") > 0.1 ) || ( queryOptional("/Cycles1PortUtilized") > 0.2) && ( ( query("/MemBound") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                        </xsl:otherwise>
                    </xsl:choose>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%ContestedAccesses" id="ContestedAccesses">
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <issueEval>
                                <![CDATA[ ( ( ( ( query("/ContestedAccesses") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) || ( queryOptional("/FalseSharing") > 0.1) ) && ( ( ( query("/MemBound") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                        </xsl:otherwise>
                    </xsl:choose>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%DataSharing" id="DataSharing">
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <issueEval>
                                <![CDATA[ ( ( ( ( query("/DataSharing") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/MemBound") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                        </xsl:otherwise>
                    </xsl:choose>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%L3Latency" id="L3Latency">
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <issueEval>
                                <![CDATA[ ( ( ( ( query("/L3Latency") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/MemBound") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                        </xsl:otherwise>
                    </xsl:choose>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%SQFull" id="SQFull">
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <issueEval>
                                <![CDATA[ ( ( ( ( query("/SQFull") > 0.3 ) && ( query("/PMUHotspot") > 0.05 ) ) || ( queryOptional("/FBFull") > 0.3) ) && ( ( ( query("/MemBound") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                        </xsl:otherwise>
                    </xsl:choose>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%LocalDRAM" id="LocalDRAM">
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <issueEval>
                                <![CDATA[ ( ( ( ( query("/LocalDRAM") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/MemBound") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                        </xsl:otherwise>
                    </xsl:choose>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%RemoteDRAM" id="RemoteDRAM">
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <issueEval>
                                <![CDATA[ ( ( ( ( query("/RemoteDRAM") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/MemBound") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                        </xsl:otherwise>
                    </xsl:choose>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%RemoteCache" id="RemoteCache">
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <issueEval>
                                <![CDATA[ ( ( ( ( query("/RemoteCache") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/MemBound") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                        </xsl:otherwise>
                    </xsl:choose>
                    <confidenceEval>
