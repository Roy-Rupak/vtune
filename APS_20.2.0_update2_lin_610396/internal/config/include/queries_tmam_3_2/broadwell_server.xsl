        ...
        <bag>
            ...
            <queryLibrary>
                ...
                <derivedQuery displayName="%Port6" id="Port6">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( query("/Port6") > 0.6 ) ) && ( ( ( query("/Cycles3mPortsUtilized") > 0.7 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/PortUtil") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/CoreBound") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%Port7" id="Port7">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( query("/Port7") > 0.6 ) ) && ( ( ( query("/Cycles3mPortsUtilized") > 0.7 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/PortUtil") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/CoreBound") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%LOAD_L1_MISS_NET" id="LOAD_L1_MISS_NET">
                    ...
                    <valueEval>
                        <![CDATA[ ( query("/LOAD_L1_MISS_CLT") + query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_L3_MISS_RETIRED.LOCAL_DRAM_PS]") + query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_L3_MISS_RETIRED.REMOTE_DRAM_PS]") + query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_L3_MISS_RETIRED.REMOTE_HITM_PS]") + query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_L3_MISS_RETIRED.REMOTE_FWD_PS]") ) ]]></valueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%LOAD_L3_HIT" id="LOAD_L3_HIT">
                    ...
                    <valueEval>
                        <![CDATA[ ( query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L3_HIT_PS]") * ( 1 + query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") / query("/LOAD_L1_MISS_NET") ) ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L3_HIT_PS]") >= 10 ) && (  ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") >= 10 ) && ( ( ( ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L2_HIT_PS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L3_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_L3_HIT_RETIRED.XSNP_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_L3_HIT_RETIRED.XSNP_HITM_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_L3_HIT_RETIRED.XSNP_MISS_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_L3_MISS_RETIRED.LOCAL_DRAM_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_L3_MISS_RETIRED.REMOTE_DRAM_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_L3_MISS_RETIRED.REMOTE_HITM_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_L3_MISS_RETIRED.REMOTE_FWD_PS]") >= 10 ) ) ) ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
