        ...
        <bag>
            ...
            <queryLibrary>
                ...
                <derivedQuery displayName="%FalseSharing" id="FalseSharing">
                    ...
                    <valueEval>
                        <![CDATA[ ( ( query("/Mem_Remote_HitM_Cost") * query("/PMUEventCount/PMUEventType[OFFCORE_RESPONSE:request=DEMAND_RFO:response=LLC_MISS.REMOTE_HITM]") + query("/Cycles_False_Sharing_Client") ) / query("/DerivedClockticks") ) ]]></valueEval>
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( (  ( query("/PMUSampleCount/PMUEventType[OFFCORE_RESPONSE:request=DEMAND_RFO:response=LLC_MISS.REMOTE_HITM]") >= 10 ) ) || (  ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_L3_HIT_RETIRED.XSNP_HITM_PS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[OFFCORE_RESPONSE:request=DEMAND_RFO:response=LLC_HIT.HITM_OTHER_CORE]") >= 10 ) ) ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                ...
                <derivedQuery displayName="%Cycles_False_Sharing_Client" id="Cycles_False_Sharing_Client">
                    ...
                    <valueEval>
                        <![CDATA[ ( query("/Mem_XSNP_HitM_Cost") * ( query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_L3_HIT_RETIRED.XSNP_HITM_PS]") + query("/PMUEventCount/PMUEventType[OFFCORE_RESPONSE:request=DEMAND_RFO:response=LLC_HIT.HITM_OTHER_CORE]") ) ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( (  ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_L3_HIT_RETIRED.XSNP_HITM_PS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[OFFCORE_RESPONSE:request=DEMAND_RFO:response=LLC_HIT.HITM_OTHER_CORE]") >= 10 ) ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
