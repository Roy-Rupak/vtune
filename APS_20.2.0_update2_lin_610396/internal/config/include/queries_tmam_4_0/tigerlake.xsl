    ...
    <xsl:template match="/">
        <bag>
            ...
            <queryLibrary>
                ...
                <derivedQuery displayName="%PERF_METRICS_SUM" id="PERF_METRICS_SUM">
                    <description>%PERF_METRICS_SUMDescriptionAll</description>
                    <helpKeyword>configs.perf_metrics_sum_perf_metrics_sumdescriptionall</helpKeyword>
                </derivedQuery>
            ...
            <locatorqueryLibrary>
                ...
                <derivedQuery displayName="%PERF_METRICS_SUM" id="locatorPERF_METRICS_SUM">
                    <queryInherit>/GeMetricBaseLocator</queryInherit>
                    <description>%PERF_METRICS_SUMDescriptionAll</description>
                    <helpKeyword>configs.perf_metrics_sum_perf_metrics_sumdescriptionall</helpKeyword>
                </derivedQuery>
