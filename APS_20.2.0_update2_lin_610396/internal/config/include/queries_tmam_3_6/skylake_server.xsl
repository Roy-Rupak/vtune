        ...
        <bag>
            ...
            <queryLibrary>
                ...
                <derivedQuery displayName="%FalseSharing" id="FalseSharing">
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( ($useCountingMode || $useAggregatedCounting) ? $TRUE : ( ( ( (  ( ( ( query("/PMUSampleCount/PMUEventType[OFFCORE_RESPONSE:request=DEMAND_RFO:response=L3_MISS.REMOTE_HITM]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[OFFCORE_RESPONSE:request=PF_L3_RFO:response=L3_MISS.REMOTE_HITM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[OFFCORE_RESPONSE:request=PF_L2_RFO:response=L3_MISS.REMOTE_HITM]") >= 10 ) ) ) || (  ( ( ( query("/PMUSampleCount/PMUEventType[OFFCORE_RESPONSE:request=DEMAND_RFO:response=L3_HIT.HITM_OTHER_CORE]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[OFFCORE_RESPONSE:request=PF_L3_RFO:response=L3_HIT.HITM_OTHER_CORE]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[OFFCORE_RESPONSE:request=PF_L2_RFO:response=L3_HIT.HITM_OTHER_CORE]") >= 10 ) ) ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 ) && ( $shortCollectionMux ? $FALSE : $TRUE )) ]]></confidenceEval>
                </derivedQuery>
                ...
                <derivedQuery displayName="%OCR_all_rfo_l3_hit_snoop_hitm" id="OCR_all_rfo_l3_hit_snoop_hitm">
                    ...
                    <valueEval>
                        <![CDATA[ ( query("/PMUEventCount/PMUEventType[OFFCORE_RESPONSE:request=DEMAND_RFO:response=L3_HIT.HITM_OTHER_CORE]") + query("/PMUEventCount/PMUEventType[OFFCORE_RESPONSE:request=PF_L3_RFO:response=L3_HIT.HITM_OTHER_CORE]") + query("/PMUEventCount/PMUEventType[OFFCORE_RESPONSE:request=PF_L2_RFO:response=L3_HIT.HITM_OTHER_CORE]") ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( ($useCountingMode || $useAggregatedCounting) ? $TRUE : ( ( ( ( query("/PMUSampleCount/PMUEventType[OFFCORE_RESPONSE:request=DEMAND_RFO:response=L3_HIT.HITM_OTHER_CORE]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[OFFCORE_RESPONSE:request=PF_L3_RFO:response=L3_HIT.HITM_OTHER_CORE]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[OFFCORE_RESPONSE:request=PF_L2_RFO:response=L3_HIT.HITM_OTHER_CORE]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 ) && ( $shortCollectionMux ? $FALSE : $TRUE )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%OCR_all_rfo_l3_miss_remote_hitm" id="OCR_all_rfo_l3_miss_remote_hitm">
                    ...
                    <valueEval>
                        <![CDATA[ ( query("/PMUEventCount/PMUEventType[OFFCORE_RESPONSE:request=DEMAND_RFO:response=L3_MISS.REMOTE_HITM]") + query("/PMUEventCount/PMUEventType[OFFCORE_RESPONSE:request=PF_L3_RFO:response=L3_MISS.REMOTE_HITM]") + query("/PMUEventCount/PMUEventType[OFFCORE_RESPONSE:request=PF_L2_RFO:response=L3_MISS.REMOTE_HITM]") ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( ($useCountingMode || $useAggregatedCounting) ? $TRUE : ( ( ( ( query("/PMUSampleCount/PMUEventType[OFFCORE_RESPONSE:request=DEMAND_RFO:response=L3_MISS.REMOTE_HITM]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[OFFCORE_RESPONSE:request=PF_L3_RFO:response=L3_MISS.REMOTE_HITM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[OFFCORE_RESPONSE:request=PF_L2_RFO:response=L3_MISS.REMOTE_HITM]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 ) && ( $shortCollectionMux ? $FALSE : $TRUE )) ]]></confidenceEval>
                </derivedQuery>
