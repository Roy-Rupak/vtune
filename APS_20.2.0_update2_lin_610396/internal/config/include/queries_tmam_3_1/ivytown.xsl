        ...
        <bag>
            ...
            <queryLibrary>
                ...
                <derivedQuery displayName="%Cycles3mPortsUtilized" id="Cycles3mPortsUtilized">
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE_CYCLES_GE_3]") >= 10 )  ) ) if ( query("/SMT_on") ) else ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CYCLES_GE_3_UOPS_EXEC]") >= 10 ) ) ) && ( query("/ClocktickSamples") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                ...
                <derivedQuery displayName="%Cycles_0_Ports_Utilized" id="Cycles_0_Ports_Utilized">
                    ...
                    <valueEval>
                        <![CDATA[ ( ( query("/PMUEventCount/PMUEventType[UOPS_EXECUTED.CORE_CYCLES_GE_1]") ) / 2 if query("/SMT_on") else ( query("/STALLS_TOTAL") - query("/Frontend_RS_Empty_Cycles") ) ) ]]></valueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%Cycles_1_Port_Utilized" id="Cycles_1_Port_Utilized">
                    ...
                    <valueEval>
                        <![CDATA[ ( ( query("/PMUEventCount/PMUEventType[UOPS_EXECUTED.CORE_CYCLES_GE_1]") - query("/PMUEventCount/PMUEventType[UOPS_EXECUTED.CORE_CYCLES_GE_2]") ) / 2 if query("/SMT_on") else ( query("/PMUEventCount/PMUEventType[UOPS_EXECUTED.CYCLES_GE_1_UOP_EXEC]") - query("/PMUEventCount/PMUEventType[UOPS_EXECUTED.CYCLES_GE_2_UOPS_EXEC]") ) ) ]]></valueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%Cycles_2_Ports_Utilized" id="Cycles_2_Ports_Utilized">
                    ...
                    <valueEval>
                        <![CDATA[ ( ( query("/PMUEventCount/PMUEventType[UOPS_EXECUTED.CORE_CYCLES_GE_2]") - query("/PMUEventCount/PMUEventType[UOPS_EXECUTED.CORE_CYCLES_GE_3]") ) / 2 if query("/SMT_on") else ( query("/PMUEventCount/PMUEventType[UOPS_EXECUTED.CYCLES_GE_2_UOPS_EXEC]") - query("/PMUEventCount/PMUEventType[UOPS_EXECUTED.CYCLES_GE_3_UOPS_EXEC]") ) ) ]]></valueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%Cycles_3m_Ports_Utilized" id="Cycles_3m_Ports_Utilized">
                    ...
                    <valueEval>
                        <![CDATA[ ( ( query("/PMUEventCount/PMUEventType[UOPS_EXECUTED.CORE_CYCLES_GE_3]") / 2 ) if query("/SMT_on") else query("/PMUEventCount/PMUEventType[UOPS_EXECUTED.CYCLES_GE_3_UOPS_EXEC]") ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE_CYCLES_GE_3]") >= 10 )  ) ) if ( query("/SMT_on") ) else ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CYCLES_GE_3_UOPS_EXEC]") >= 10 ) ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
