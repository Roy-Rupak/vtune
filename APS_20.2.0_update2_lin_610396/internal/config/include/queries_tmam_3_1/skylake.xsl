        ...
        <bag>
            ...
            <queryLibrary>
                ...
                <derivedQuery displayName="%BranchResteers" id="BranchResteers">
                    ...
                    <valueEval>
                        <![CDATA[ ( ( query("/PMUEventCount/PMUEventType[INT_MISC.CLEAR_RESTEER_CYCLES]") + 10 * query("/PMUEventCount/PMUEventType[BACLEARS.ANY]") ) / query("/DerivedClockticks") ) ]]></valueEval>
                ...
                <derivedQuery displayName="%L2Bound" id="L2Bound">
                    ...
                    <valueEval>
                        <![CDATA[ ( ( 1 if query("/FBFull") < 1.5 else query("/LOAD_L2_HIT") / ( query("/LOAD_L2_HIT") + query("/PMUEventCount/PMUEventType[L1D_PEND_MISS.FB_FULL]") ) ) * query("/L2_Bound_Fraction") ) ]]></valueEval>
