            ...
            <queryLibrary>
                ...
                <derivedQuery displayName="%LocalDRAM" id="LocalDRAM">
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <issueEval>
                                <![CDATA[ ( ( ( ( query("/LocalDRAM") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.1 ) ) ) ]]></issueEval>
                        </xsl:otherwise>
                    </xsl:choose>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%RemoteDRAM" id="RemoteDRAM">
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <issueEval>
                                <![CDATA[ ( ( ( ( query("/RemoteDRAM") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.1 ) ) ) ]]></issueEval>
                        </xsl:otherwise>
                    </xsl:choose>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%RemoteCache" id="RemoteCache">
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <issueEval>
                                <![CDATA[ ( ( ( ( query("/RemoteCache") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.1 ) ) ) ]]></issueEval>
                        </xsl:otherwise>
                    </xsl:choose>
                    <confidenceEval>
