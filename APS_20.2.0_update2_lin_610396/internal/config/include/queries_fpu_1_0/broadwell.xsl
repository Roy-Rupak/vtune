    ...
    <xsl:template match="/">
        <queryLibrary>
            ...
            <derivedQuery id="X87FLOP_INSTR">
                <valueEval>
                    <![CDATA[ ( query("/PMUEventCount/PMUEventType[INST_RETIRED.X87]") ) ]]></valueEval>
            </derivedQuery>
