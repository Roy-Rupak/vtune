    ...
    <xsl:template match="/">
        <queryLibrary>
                                                ...
                                                <derivedQuery id="PackedSPFPRatioGroup">
                                                    ...
                                                    <expand>
                                                        <vectorQuery id="PackedSPFPRatioGroupExpanded">
                                                            ...
                                                            <queryRef>/512PackedSPFPRatio</queryRef>
                                                        </vectorQuery>
                                                    </expand>
                                                </derivedQuery>
                                                ...
                                                <derivedQuery id="PackedDPFPRatioGroup">
                                                    ...
                                                    <expand>
                                                        <vectorQuery id="PackedDPFPRatioGroupExpanded">
                                                            ...
                                                            <queryRef>/512PackedDPFPRatio</queryRef>
                                                        </vectorQuery>
                                                    </expand>
                                                </derivedQuery>
            ...
            <derivedQuery id="SPFLOP_INSTR">
                <valueEval>
                    <![CDATA[ ( query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.SCALAR_SINGLE]") + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.128B_PACKED_SINGLE]") + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.256B_PACKED_SINGLE]") + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.512B_PACKED_SINGLE]") ) ]]></valueEval>
            </derivedQuery>
            <derivedQuery displayName="%PackedSPFPRatio" id="PackedSPFPRatio">
                ...
                <valueEval>
                    <![CDATA[ ( ( query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.128B_PACKED_SINGLE]") + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.256B_PACKED_SINGLE]") + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.512B_PACKED_SINGLE]") ) / query("/SPFLOP_INSTR") ) ]]></valueEval>
                <confidenceEval>
                    <![CDATA[ ( ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
            </derivedQuery>
            <derivedQuery displayName="%256PackedSPFPRatio" id="256PackedSPFPRatio">
                ...
                <valueEval>
                    <![CDATA[ ( ( query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.256B_PACKED_SINGLE]") ) / query("/SPFLOP_INSTR") ) ]]></valueEval>
                <issues>
                    <issue>
                        <issueEval>
                            <![CDATA[ ( ( query("/256PackedSPFPRatio")  > 0.05 ) && query("/AdditionalIssueConditional")  ) ]]></issueEval>
                        <issueText>%PartialVectorLoadIssueText</issueText>
                    </issue>
                </issues>
                <confidenceEval>
                    <![CDATA[ ( ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
            ...
            <derivedQuery displayName="%InstrSet" id="InstrSet">
                ...
                <issues>
                    <issue>
                        <issueEval>
                            <![CDATA[ ( query("/InstrSet") && !( ( query("/InstrSet") contains "AVX512" ) ) && query("/AdditionalIssueConditional")  ) ]]></issueEval>
            ...
            <derivedQuery id="FPArithInst">
                <valueEval>
                    <![CDATA[ ( query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.SCALAR_SINGLE]") + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.128B_PACKED_SINGLE]") + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.256B_PACKED_SINGLE]") + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.SCALAR_DOUBLE]") + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.128B_PACKED_DOUBLE]") + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.256B_PACKED_DOUBLE]") + query("/PMUEventCount/PMUEventType[UOPS_EXECUTED.X87]") + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.512B_PACKED_DOUBLE]") + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.512B_PACKED_SINGLE]") ) ]]></valueEval>
            </derivedQuery>
            <derivedQuery id="ScalarFP">
                <valueType>double</valueType>
                <valueEval>
                    <![CDATA[ ( query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.SCALAR_SINGLE]") + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.SCALAR_DOUBLE]") + query("/PMUEventCount/PMUEventType[UOPS_EXECUTED.X87]") ) ]]></valueEval>
            </derivedQuery>
            <derivedQuery displayName="%PackedDPFPRatio" id="PackedDPFPRatio">
                ...
                <valueEval>
                    <![CDATA[ ( ( query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.128B_PACKED_DOUBLE]") + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.256B_PACKED_DOUBLE]") + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.512B_PACKED_DOUBLE]") ) / query("/DPFLOP_INSTR") ) ]]></valueEval>
                <confidenceEval>
                    <![CDATA[ ( ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
            </derivedQuery>
            <derivedQuery displayName="%FPInstrPerMemWrite" id="FPInstrPerMemWrite">
                ...
                <confidenceEval>
                    <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( ( ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[FP_ARITH_INST_RETIRED.SCALAR_SINGLE]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[FP_ARITH_INST_RETIRED.128B_PACKED_SINGLE]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[FP_ARITH_INST_RETIRED.256B_PACKED_SINGLE]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[FP_ARITH_INST_RETIRED.SCALAR_DOUBLE]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[FP_ARITH_INST_RETIRED.128B_PACKED_DOUBLE]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[FP_ARITH_INST_RETIRED.256B_PACKED_DOUBLE]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.X87]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[FP_ARITH_INST_RETIRED.512B_PACKED_DOUBLE]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[FP_ARITH_INST_RETIRED.512B_PACKED_SINGLE]") >= 10 ) )  ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
            </derivedQuery>
            ...
            <derivedQuery id="DPFLOP_INSTR">
                <valueEval>
                    <![CDATA[ ( query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.SCALAR_DOUBLE]") + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.128B_PACKED_DOUBLE]") + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.256B_PACKED_DOUBLE]") + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.512B_PACKED_DOUBLE]") ) ]]></valueEval>
            </derivedQuery>
            <derivedQuery displayName="%FLOPSPerInstructionMultiIssue" id="FLOPSPerInstructionMultiIssue">
                ...
                <valueEval>
                    <![CDATA[ ( ( query("/FLOP") / query("/FPArithInst") ) / 16 ) ]]></valueEval>
                <issues>
                    <issue>
                        <issueEval>
            ...
            <derivedQuery displayName="%FLOP" id="FLOP">
                ...
                <valueEval>
                    <![CDATA[ ( query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.SCALAR_SINGLE]") + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.128B_PACKED_SINGLE]") * 4 + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.256B_PACKED_SINGLE]") * 8 + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.SCALAR_DOUBLE]") * 2 + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.128B_PACKED_DOUBLE]") * 4 + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.256B_PACKED_DOUBLE]") * 8 + query("/PMUEventCount/PMUEventType[UOPS_EXECUTED.X87]") + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.512B_PACKED_DOUBLE]") * 16 + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.512B_PACKED_SINGLE]") * 16 ) ]]></valueEval>
                <confidenceEval>
                    <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[FP_ARITH_INST_RETIRED.SCALAR_SINGLE]") >= 10 ) || ( ( query("/PMUSampleCount/PMUEventType[FP_ARITH_INST_RETIRED.128B_PACKED_SINGLE]") >= 10 )  ) ) || ( ( query("/PMUSampleCount/PMUEventType[FP_ARITH_INST_RETIRED.256B_PACKED_SINGLE]") >= 10 )  ) ) || ( ( query("/PMUSampleCount/PMUEventType[FP_ARITH_INST_RETIRED.SCALAR_DOUBLE]") >= 10 )  ) ) || ( ( query("/PMUSampleCount/PMUEventType[FP_ARITH_INST_RETIRED.128B_PACKED_DOUBLE]") >= 10 )  ) ) || ( ( query("/PMUSampleCount/PMUEventType[FP_ARITH_INST_RETIRED.256B_PACKED_DOUBLE]") >= 10 )  ) ) || ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.X87]") >= 10 ) ) || ( ( query("/PMUSampleCount/PMUEventType[FP_ARITH_INST_RETIRED.512B_PACKED_DOUBLE]") >= 10 )  ) ) || ( ( query("/PMUSampleCount/PMUEventType[FP_ARITH_INST_RETIRED.512B_PACKED_SINGLE]") >= 10 )  ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
            </derivedQuery>
            <derivedQuery displayName="%128PackedDPFPRatio" id="128PackedDPFPRatio">
                ...
                <valueEval>
                    <![CDATA[ ( ( query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.128B_PACKED_DOUBLE]") ) / query("/DPFLOP_INSTR") ) ]]></valueEval>
                <issues>
                    <issue>
                        <issueEval>
            ...
            <derivedQuery displayName="%ScalarSPFPRatio" id="ScalarSPFPRatio">
                ...
                <valueEval>
                    <![CDATA[ ( ( query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.SCALAR_SINGLE]") ) / query("/SPFLOP_INSTR") ) ]]></valueEval>
                <issues>
                    <issue>
                        <issueEval>
            ...
            <derivedQuery displayName="%256PackedDPFPRatio" id="256PackedDPFPRatio">
                ...
                <valueEval>
                    <![CDATA[ ( ( query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.256B_PACKED_DOUBLE]") ) / query("/DPFLOP_INSTR") ) ]]></valueEval>
                <issues>
                    <issue>
                        <issueEval>
                            <![CDATA[ ( ( query("/256PackedDPFPRatio")  > 0.05 ) && query("/AdditionalIssueConditional")  ) ]]></issueEval>
                        <issueText>%PartialVectorLoadIssueText</issueText>
                    </issue>
                </issues>
                <confidenceEval>
            ...
            <derivedQuery displayName="%512PackedDPFPRatio" id="512PackedDPFPRatio">
                <unitOfMeasureQueryId>DPFPForUnits</unitOfMeasureQueryId>
                <valueType>ratio</valueType>
                <helpKeyword>configs.512packeddpfpratio_512packeddpfpratiodescriptionall</helpKeyword>
                <description>%512PackedDPFPRatioDescriptionAll</description>
                <valueEval>
                    <![CDATA[ ( ( query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.512B_PACKED_DOUBLE]") ) / query("/DPFLOP_INSTR") ) ]]></valueEval>
                <confidenceEval>
                    <![CDATA[ ( ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
            </derivedQuery>
            ...
            <derivedQuery displayName="%512PackedSPFPRatio" id="512PackedSPFPRatio">
                <unitOfMeasureQueryId>SPFPForUnits</unitOfMeasureQueryId>
                <valueType>ratio</valueType>
                <helpKeyword>configs.512packedspfpratio_512packedspfpratiodescriptionall</helpKeyword>
                <description>%512PackedSPFPRatioDescriptionAll</description>
                <valueEval>
                    <![CDATA[ ( ( query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.512B_PACKED_SINGLE]") ) / query("/SPFLOP_INSTR") ) ]]></valueEval>
                <confidenceEval>
                    <![CDATA[ ( ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
            </derivedQuery>
            <derivedQuery displayName="%ScalarDPFPRatio" id="ScalarDPFPRatio">
                ...
                <valueEval>
                    <![CDATA[ ( ( query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.SCALAR_DOUBLE]") ) / query("/DPFLOP_INSTR") ) ]]></valueEval>
                <issues>
                    <issue>
                        <issueEval>
            ...
            <derivedQuery id="X87FLOP_INSTR">
                <valueEval>
                    <![CDATA[ ( query("/PMUEventCount/PMUEventType[UOPS_EXECUTED.X87]") ) ]]></valueEval>
            </derivedQuery>
            ...
            <derivedQuery displayName="%128PackedSPFPRatio" id="128PackedSPFPRatio">
                ...
                <valueEval>
                    <![CDATA[ ( ( query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.128B_PACKED_SINGLE]") ) / query("/SPFLOP_INSTR") ) ]]></valueEval>
                <issues>
                    <issue>
                        <issueEval>
            ...
            <derivedQuery id="SPFLOP">
                <valueEval>
                    <![CDATA[ ( query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.SCALAR_SINGLE]") + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.128B_PACKED_SINGLE]") * 4 + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.256B_PACKED_SINGLE]") * 8 + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.512B_PACKED_SINGLE]") * 16 ) ]]></valueEval>
            </derivedQuery>
            <derivedQuery id="PackedFP">
                <valueType>double</valueType>
                <valueEval>
                    <![CDATA[ ( query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.128B_PACKED_SINGLE]") + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.256B_PACKED_SINGLE]") + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.128B_PACKED_DOUBLE]") + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.256B_PACKED_DOUBLE]") + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.512B_PACKED_DOUBLE]") + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.512B_PACKED_SINGLE]") ) ]]></valueEval>
            </derivedQuery>
            ...
            <derivedQuery id="DPFLOP">
                <valueEval>
                    <![CDATA[ ( query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.SCALAR_DOUBLE]") + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.128B_PACKED_DOUBLE]") * 2 + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.256B_PACKED_DOUBLE]") * 4 + query("/PMUEventCount/PMUEventType[FP_ARITH_INST_RETIRED.512B_PACKED_DOUBLE]") * 8 ) ]]></valueEval>
            </derivedQuery>
