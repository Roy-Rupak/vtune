        ...
        <bag>
            ...
            <queryLibrary>
                ...
                <derivedQuery displayName="%L2Bound" id="L2Bound">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/L2Bound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/MemBound") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%ContestedAccesses" id="ContestedAccesses">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/ContestedAccesses") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) || ( queryOptional("/FalseSharing") > 0.1) ) && ( ( ( query("/L3Bound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/MemBound") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%DataSharing" id="DataSharing">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/DataSharing") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/L3Bound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/MemBound") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%SQFull" id="SQFull">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/SQFull") > 0.3 ) && ( query("/PMUHotspot") > 0.05 ) ) || ( queryOptional("/FBFull") > 0.3) || ( queryOptional("/MEMBandwidth") > 0.1) ) && ( ( ( query("/L3Bound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/MemBound") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%ITLB_Miss_Cycles" id="ITLB_Miss_Cycles">
                    ...
                    <valueEval>
                        <![CDATA[ ( ( 9 * query("/PMUEventCount/PMUEventType[ITLB_MISSES.STLB_HIT]") + query("/PMUEventCount/PMUEventType[ITLB_MISSES.WALK_DURATION]") ) ) ]]></valueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%LOAD_L1_MISS_CLT" id="LOAD_L1_MISS_CLT">
                    ...
                    <valueEval>
                        <![CDATA[ ( query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L2_HIT_PS]") + query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") + query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]") + query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") + query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_MISS_PS]") + 0.001 ) ]]></valueEval>
                    <confidenceEval>
            ...
            <locatorqueryLibrary>
                ...
                <derivedQuery displayName="%L2Bound" id="locatorL2Bound">
                    ...
                    <issueText>%L2BoundIssueTextAll</issueText>
                    <issueEval>
                        <![CDATA[ ( ( query("/locatorL2Bound") > 0.1 ) ) ]]></issueEval>
                </derivedQuery>
                <derivedQuery displayName="%L3Bound" id="locatorL3Bound">
                    ...
                    <helpKeyword>configs.l3bound_l3bounddescriptionall</helpKeyword>
                    <confidenceEval>
                        <![CDATA[ ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 )) ]]></confidenceEval>
                    <valueEval>
                ...
                <derivedQuery displayName="%ContestedAccesses" id="locatorContestedAccesses">
                    ...
                    <helpKeyword>configs.contestedaccesses_contestedaccessesdescriptionall</helpKeyword>
                    <confidenceEval>
                        <![CDATA[ ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]") >= 10 )) ]]></confidenceEval>
                    <valueEval>
                ...
                <derivedQuery displayName="%DataSharing" id="locatorDataSharing">
                    ...
                    <helpKeyword>configs.datasharing_datasharingdescriptionall</helpKeyword>
                    <confidenceEval>
                        <![CDATA[ ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") >= 10 )) ]]></confidenceEval>
                    <valueEval>
                ...
                <derivedQuery displayName="%DRAMBound" id="locatorDRAMBound">
                    ...
                    <helpKeyword>configs.drambound_drambounddescriptionall</helpKeyword>
                    <confidenceEval>
                        <![CDATA[ ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_MISS_PS]") >= 10 )) ]]></confidenceEval>
                    <valueEval>
                ...
                <derivedQuery displayName="%RemoteDRAM" id="locatorRemoteDRAM">
                    ...
                    <helpKeyword>configs.remotedram_remotedramdescriptionall</helpKeyword>
                    <confidenceEval>
                        <![CDATA[ ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_DRAM]") >= 10 )) ]]></confidenceEval>
                    <valueEval>
                ...
                <derivedQuery displayName="%RemoteCache" id="locatorRemoteCache">
                    ...
                    <helpKeyword>configs.remotecache_remotecachedescriptionall</helpKeyword>
                    <confidenceEval>
                        <![CDATA[ ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_HITM]") >= 10 )) ]]></confidenceEval>
                    <valueEval>
