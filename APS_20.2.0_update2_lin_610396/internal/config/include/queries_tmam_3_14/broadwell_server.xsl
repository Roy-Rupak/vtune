        ...
        <bag>
            ...
            <queryLibrary>
                ...
                <derivedQuery displayName="%ITLB_Miss_Cycles" id="ITLB_Miss_Cycles">
                    ...
                    <valueEval>
                        <![CDATA[ ( ( 9 * query("/PMUEventCount/PMUEventType[ITLB_MISSES.STLB_HIT]") + query("/PMUEventCount/PMUEventType[ITLB_MISSES.WALK_DURATION:cmask=1]") + 7 * query("/PMUEventCount/PMUEventType[ITLB_MISSES.WALK_COMPLETED]") ) ) ]]></valueEval>
                    <confidenceEval>
