        ...
        <bag>
                                        ...
                                        <derivedQuery id="StoresBoundGroup">
                                            ...
                                            <expand>
                                                <vectorQuery id="StoresBoundGroupExpanded">
                                                    <derivedQuery id="StoreLatencyGroup">
                                                        <queryInherit>/StoreLatency</queryInherit>
                                                        <displayAttributes>
                                                            <boolean:expand>false</boolean:expand>
                                                            <boolean:allowCollapse>true</boolean:allowCollapse>
                                                        </displayAttributes>
                                                        <expand>
                                                            <vectorQuery id="StoreLatencyGroupExpanded" />
                                                        </expand>
                                                    </derivedQuery>
            ...
            <queryLibrary>
                ...
                <derivedQuery displayName="%FP_Arith" id="FP_Arith">
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( ( query("/PMUSampleCount/PMUEventType[FP_COMP_OPS_EXE.X87]") >= 10 ) && ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.THREAD]") >= 10 ) ) || ( ( ( query("/PMUSampleCount/PMUEventType[FP_COMP_OPS_EXE.SSE_SCALAR_SINGLE]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[FP_COMP_OPS_EXE.SSE_SCALAR_DOUBLE]") >= 10 ) ) && ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.THREAD]") >= 10 ) ) ) || ( ( ( ( ( query("/PMUSampleCount/PMUEventType[FP_COMP_OPS_EXE.SSE_PACKED_DOUBLE]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[FP_COMP_OPS_EXE.SSE_PACKED_SINGLE]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[SIMD_FP_256.PACKED_SINGLE]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[SIMD_FP_256.PACKED_DOUBLE]") >= 10 ) ) && ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.THREAD]") >= 10 ) ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%FP_x87" id="FP_x87">
                    ...
                    <valueEval>
                        <![CDATA[ ( query("/PMUEventCount/PMUEventType[FP_COMP_OPS_EXE.X87]") / query("/PMUEventCount/PMUEventType[UOPS_EXECUTED.THREAD]") ) ]]></valueEval>
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( query("/PMUSampleCount/PMUEventType[FP_COMP_OPS_EXE.X87]") >= 10 ) && ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.THREAD]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%FP_Scalar" id="FP_Scalar">
                    ...
                    <valueEval>
                        <![CDATA[ ( ( query("/PMUEventCount/PMUEventType[FP_COMP_OPS_EXE.SSE_SCALAR_SINGLE]") + query("/PMUEventCount/PMUEventType[FP_COMP_OPS_EXE.SSE_SCALAR_DOUBLE]") ) / query("/PMUEventCount/PMUEventType[UOPS_EXECUTED.THREAD]") ) ]]></valueEval>
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( query("/PMUSampleCount/PMUEventType[FP_COMP_OPS_EXE.SSE_SCALAR_SINGLE]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[FP_COMP_OPS_EXE.SSE_SCALAR_DOUBLE]") >= 10 ) ) && ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.THREAD]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                ...
                <derivedQuery displayName="%Assists" id="Assists">
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( (  ( query("/PMUSampleCount/PMUEventType[OTHER_ASSISTS.ANY_WB_ASSIST]") >= 10 ) ) && ( query("/ClocktickSamples") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                ...
                <derivedQuery displayName="%ICacheMisses" id="ICacheMisses">
                    ...
                    <valueEval>
                        <![CDATA[ ( query("/PMUEventCount/PMUEventType[ICACHE.IFETCH_STALL]") / query("/DerivedClockticks") - query("/ITLBOverhead") ) ]]></valueEval>
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( query("/PMUSampleCount/PMUEventType[ICACHE.IFETCH_STALL]") >= 10 ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) || ( ( (  ( query("/PMUSampleCount/PMUEventType[ITLB_MISSES.STLB_HIT]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[ITLB_MISSES.WALK_DURATION]") >= 10 ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                ...
                <derivedQuery displayName="%BranchResteers" id="BranchResteers">
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[RS_EVENTS.EMPTY_CYCLES]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[ICACHE.IFETCH_STALL]") >= 10 ) ) && ( query("/PMUSampleCount/PMUEventType[RS_EVENTS.EMPTY_END]") >= 10 ) ) || ( ( ( query("/PMUSampleCount/PMUEventType[BR_MISP_RETIRED.ALL_BRANCHES_PS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[MACHINE_CLEARS.COUNT]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[BACLEARS.ANY]") >= 10 ) ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                ...
                <derivedQuery displayName="%DSB_Coverage" id="DSB_Coverage">
                    ...
                    <valueEval>
                        <![CDATA[ ( query("/PMUEventCount/PMUEventType[IDQ.DSB_UOPS]") / ( query("/PMUEventCount/PMUEventType[IDQ.DSB_UOPS]") + query("/PMUEventCount/PMUEventType[LSD.UOPS]") + query("/PMUEventCount/PMUEventType[IDQ.MITE_UOPS]") + query("/PMUEventCount/PMUEventType[IDQ.MS_UOPS]") ) ) ]]></valueEval>
                ...
                <derivedQuery displayName="%LSD_Coverage" id="LSD_Coverage">
                    ...
                    <valueEval>
                        <![CDATA[ ( query("/PMUEventCount/PMUEventType[LSD.UOPS]") / ( query("/PMUEventCount/PMUEventType[IDQ.DSB_UOPS]") + query("/PMUEventCount/PMUEventType[LSD.UOPS]") + query("/PMUEventCount/PMUEventType[IDQ.MITE_UOPS]") + query("/PMUEventCount/PMUEventType[IDQ.MS_UOPS]") ) ) ]]></valueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%L1Bound" id="L1Bound">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( ( query("/L1Bound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) || ( queryOptional("/DTLBOverhead") > 0.1 ) || ( queryOptional("/Cycles1PortUtilized") > 0.2) ) && ( ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") ) >= 10 if ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") ) < ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.STALLS_LDM_PENDING]") ) else ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.STALLS_LDM_PENDING]") ) >= 10 ) || ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.STALLS_L1D_PENDING]") >= 10 ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%DTLBOverhead" id="DTLBOverhead">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( query("/DTLBOverhead") > 0.1 ) ) && ( ( ( ( query("/L1Bound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) || ( queryOptional("/DTLBOverhead") > 0.1 ) || ( queryOptional("/Cycles1PortUtilized") > 0.2) && ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%LoadsBlockedbyStoreForwarding" id="LoadsBlockedbyStoreForwarding">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/LoadsBlockedbyStoreForwarding") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( ( query("/L1Bound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) || ( queryOptional("/DTLBOverhead") > 0.1 ) || ( queryOptional("/Cycles1PortUtilized") > 0.2) && ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%LockLatency" id="LockLatency">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/LockLatency") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) || ( queryOptional("/StoreLatency") > 0.1) ) && ( ( ( ( query("/L1Bound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) || ( queryOptional("/DTLBOverhead") > 0.1 ) || ( queryOptional("/Cycles1PortUtilized") > 0.2) && ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%SplitLoads" id="SplitLoads">
                    ...
                    <valueEval>
                        <![CDATA[ ( 13 * query("/PMUEventCount/PMUEventType[LD_BLOCKS.NO_SR]") / query("/DerivedClockticks") ) ]]></valueEval>
                    <issueText>%SplitLoadsIssueTextAll</issueText>
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/SplitLoads") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( ( query("/L1Bound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) || ( queryOptional("/DTLBOverhead") > 0.1 ) || ( queryOptional("/Cycles1PortUtilized") > 0.2) && ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( (  ( query("/PMUSampleCount/PMUEventType[LD_BLOCKS.NO_SR]") >= 10 ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%4KAliasing" id="4KAliasing">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/4KAliasing") > 0.7 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( ( query("/L1Bound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) || ( queryOptional("/DTLBOverhead") > 0.1 ) || ( queryOptional("/Cycles1PortUtilized") > 0.2) && ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%FBFull" id="FBFull">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( query("/FBFull") > 0.3 ) || ( queryOptional("/SQFull") > 0.3) || ( queryOptional("/MEMBandwidth") > 0.1) || ( queryOptional("/StoreLatency") > 0.1) ) && ( ( ( ( query("/L1Bound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) || ( queryOptional("/DTLBOverhead") > 0.1 ) || ( queryOptional("/Cycles1PortUtilized") > 0.2) && ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( ( query("/PMUSampleCount/PMUEventType[L1D_PEND_MISS.PENDING]") >= 10 ) && ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L1_MISS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") >= 10 ) ) ) || ( query("/PMUSampleCount/PMUEventType[L1D_PEND_MISS.FB_FULL:cmask=1]") >= 10 ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%L2Bound" id="L2Bound">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/L2Bound") > 0.05 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.STALLS_L1D_PENDING]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.STALLS_L2_PENDING]") >= 10 ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%L3Bound" id="L3Bound">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/L3Bound") > 0.05 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) && ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) || (  ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_MISS_PS]") >= 10 ) ) ) ) || ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.STALLS_L2_PENDING]") >= 10 ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%ContestedAccesses" id="ContestedAccesses">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/ContestedAccesses") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) || ( queryOptional("/FalseSharing") > 0.1) ) && ( ( ( query("/L3Bound") > 0.05 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( (  ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") >= 10 ) || (  ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") >= 10 ) && ( ( ( ( ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L2_HIT_PS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_MISS_PS]") >= 10 ) )  ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.LOCAL_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_HITM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_FWD]") >= 10 ) ) ) ) ) || ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_MISS_PS]") >= 10 ) || (  ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") >= 10 ) && ( ( ( ( ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L2_HIT_PS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_MISS_PS]") >= 10 ) )  ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.LOCAL_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_HITM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_FWD]") >= 10 ) ) ) ) ) ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%DataSharing" id="DataSharing">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/DataSharing") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/L3Bound") > 0.05 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( (  ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]") >= 10 ) || (  ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") >= 10 ) && ( ( ( ( ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L2_HIT_PS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_MISS_PS]") >= 10 ) )  ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.LOCAL_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_HITM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_FWD]") >= 10 ) ) ) ) ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%L3Latency" id="L3Latency">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/L3Latency") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/L3Bound") > 0.05 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( (  ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) || (  ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") >= 10 ) && ( ( ( ( ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L2_HIT_PS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_MISS_PS]") >= 10 ) )  ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.LOCAL_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_HITM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_FWD]") >= 10 ) ) ) ) )  ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%SQFull" id="SQFull">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/SQFull") > 0.3 ) && ( query("/PMUHotspot") > 0.05 ) ) || ( queryOptional("/FBFull") > 0.3) || ( queryOptional("/MEMBandwidth") > 0.1) ) && ( ( ( query("/L3Bound") > 0.05 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%DRAMBound" id="DRAMBound">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/DRAMBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( (  ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) && ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) || (  ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_MISS_PS]") >= 10 ) ) ) ) ) || ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.STALLS_L2_PENDING]") >= 10 ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%MEMBandwidth" id="MEMBandwidth">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/MEMBandwidth") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) || ( queryOptional("/FBFull") > 0.3) || ( queryOptional("/SQFull") > 0.3) ) && ( ( ( query("/DRAMBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") ) >= 10 if ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") ) < ( query("/PMUSampleCount/PMUEventType[OFFCORE_REQUESTS_OUTSTANDING.ALL_DATA_RD:cmask=6]") ) else ( query("/PMUSampleCount/PMUEventType[OFFCORE_REQUESTS_OUTSTANDING.ALL_DATA_RD:cmask=6]") ) >= 10 ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%MEMLatency" id="MEMLatency">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/MEMLatency") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/DRAMBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%LocalDRAM" id="LocalDRAM">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/LocalDRAM") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/MEMLatency") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/DRAMBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( (  ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.LOCAL_DRAM]") >= 10 ) || (  ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") >= 10 ) && ( ( ( ( ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L2_HIT_PS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_MISS_PS]") >= 10 ) )  ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.LOCAL_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_HITM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_FWD]") >= 10 ) ) ) ) ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%RemoteDRAM" id="RemoteDRAM">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/RemoteDRAM") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/MEMLatency") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/DRAMBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( (  ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_DRAM]") >= 10 ) || (  ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") >= 10 ) && ( ( ( ( ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L2_HIT_PS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_MISS_PS]") >= 10 ) )  ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.LOCAL_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_HITM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_FWD]") >= 10 ) ) ) ) ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%RemoteCache" id="RemoteCache">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/RemoteCache") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/MEMLatency") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/DRAMBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( (  ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_HITM]") >= 10 ) || (  ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") >= 10 ) && ( ( ( ( ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L2_HIT_PS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_MISS_PS]") >= 10 ) )  ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.LOCAL_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_HITM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_FWD]") >= 10 ) ) ) ) ) ) || (  ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_FWD]") >= 10 ) || (  ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") >= 10 ) && ( ( ( ( ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L2_HIT_PS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_MISS_PS]") >= 10 ) )  ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.LOCAL_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_HITM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_FWD]") >= 10 ) ) ) ) ) ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%StoresBound" id="StoresBound">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/StoresBound") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%StoreLatency" id="StoreLatency">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/StoreLatency") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) || ( queryOptional("/LockLatency") > 0.2) || ( queryOptional("/FBFull") > 0.3) ) && ( ( ( query("/StoresBound") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%FalseSharing" id="FalseSharing">
                    ...
                    <valueEval>
                        <![CDATA[ ( ( query("/Mem_Remote_HitM_Cost") * query("/PMUEventCount/PMUEventType[OFFCORE_RESPONSE.DEMAND_RFO.LLC_MISS.REMOTE_HITM_1]") + query("/Mem_XSNP_HitM_Cost") * query("/PMUEventCount/PMUEventType[OFFCORE_RESPONSE.DEMAND_RFO.LLC_HIT.HITM_OTHER_CORE_0]") ) / query("/DerivedClockticks") ) ]]></valueEval>
                    <issueText>%FalseSharingIssueTextAll</issueText>
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/FalseSharing") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) || ( queryOptional("/ContestedAccesses") > 0.2) ) && ( ( ( query("/StoresBound") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( (  ( query("/PMUSampleCount/PMUEventType[OFFCORE_RESPONSE.DEMAND_RFO.LLC_MISS.REMOTE_HITM_1]") >= 10 ) ) || (  ( query("/PMUSampleCount/PMUEventType[OFFCORE_RESPONSE.DEMAND_RFO.LLC_HIT.HITM_OTHER_CORE_0]") >= 10 ) ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%SplitStores" id="SplitStores">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/SplitStores") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) || ( queryOptional("/Port4") > 0.6) ) && ( ( ( query("/StoresBound") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%DTLBStoreOverhead" id="DTLBStoreOverhead">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/DTLBStoreOverhead") > 0.05 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/StoresBound") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%PortUtil" id="PortUtil">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/PortUtil") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/CoreBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") ) >= 10 if ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") ) < ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.CYCLES_NO_EXECUTE]") ) else ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.CYCLES_NO_EXECUTE]") ) >= 10 ) || ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CYCLES_GE_1_UOP_EXEC]") >= 10 ) ) || ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CYCLES_GE_3_UOPS_EXEC]") >= 10 ) ) if ( ( query("/IPC") > 1.8 ) ) else ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CYCLES_GE_2_UOPS_EXEC]") >= 10 ) ) ) ) || ( ( ( query("/PMUSampleCount/PMUEventType[RS_EVENTS.EMPTY_CYCLES]") >= 10 ) ) if ( ( query("/FELatency") > 0.1 ) ) else ( 0 ) ) ) || ( query("/PMUSampleCount/PMUEventType[RESOURCE_STALLS.SB]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[RESOURCE_STALLS.SB]") >= 10 ) ) || ( ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") ) >= 10 if ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") ) < ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.STALLS_LDM_PENDING]") ) else ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.STALLS_LDM_PENDING]") ) >= 10 ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%Cycles0PortsUtilized" id="Cycles0PortsUtilized">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/Cycles0PortsUtilized") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/PortUtil") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/CoreBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=1]") >= 10 ) && ( ( 2 ) if ( query("/SMT_on") ) else ( ( ( ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") ) >= 10 if ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") ) < ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.CYCLES_NO_EXECUTE]") ) else ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.CYCLES_NO_EXECUTE]") ) >= 10 ) || ( ( ( query("/PMUSampleCount/PMUEventType[RS_EVENTS.EMPTY_CYCLES]") >= 10 ) ) if ( ( query("/FELatency") > 0.1 ) ) else ( 0 ) ) ) ) ) ) && ( query("/ClocktickSamples") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%Cycles1PortUtilized" id="Cycles1PortUtilized">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/Cycles1PortUtilized") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) || ( queryOptional("/L1Bound") > 0.1) ) && ( ( ( query("/PortUtil") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/CoreBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=1]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=2]") >= 10 ) ) && ( ( 2 ) if ( query("/SMT_on") ) else ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CYCLES_GE_1_UOP_EXEC]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CYCLES_GE_2_UOPS_EXEC]") >= 10 ) ) ) ) ) && ( query("/ClocktickSamples") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%Cycles2PortsUtilized" id="Cycles2PortsUtilized">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/Cycles2PortsUtilized") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/PortUtil") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/CoreBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=2]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=3]") >= 10 ) ) && ( ( 2 ) if ( query("/SMT_on") ) else ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CYCLES_GE_2_UOPS_EXEC]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CYCLES_GE_3_UOPS_EXEC]") >= 10 ) ) ) ) ) && ( query("/ClocktickSamples") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%Cycles3mPortsUtilized" id="Cycles3mPortsUtilized">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/Cycles3mPortsUtilized") > 0.7 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/PortUtil") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/CoreBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=3]") >= 10 )  ) ) if ( query("/SMT_on") ) else ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CYCLES_GE_3_UOPS_EXEC]") >= 10 ) ) ) && ( query("/ClocktickSamples") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%Port0" id="Port0">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( query("/Port0") > 0.6 ) ) && ( ( ( query("/Cycles3mPortsUtilized") > 0.7 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/PortUtil") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/CoreBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%Port1" id="Port1">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( query("/Port1") > 0.6 ) ) && ( ( ( query("/Cycles3mPortsUtilized") > 0.7 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/PortUtil") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/CoreBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%Port2" id="Port2">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( query("/Port2") > 0.6 ) ) && ( ( ( query("/Cycles3mPortsUtilized") > 0.7 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/PortUtil") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/CoreBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%Port3" id="Port3">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( query("/Port3") > 0.6 ) ) && ( ( ( query("/Cycles3mPortsUtilized") > 0.7 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/PortUtil") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/CoreBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%Port4" id="Port4">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( query("/Port4") > 0.6 ) || ( queryOptional("/SplitStores") > 0.2) ) && ( ( ( query("/Cycles3mPortsUtilized") > 0.7 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/PortUtil") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/CoreBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%Port5" id="Port5">
                    ...
                    <issueEval>
                        <![CDATA[ ( ( ( query("/Port5") > 0.6 ) ) && ( ( ( query("/Cycles3mPortsUtilized") > 0.7 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/PortUtil") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/CoreBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%BAClear_Cost" id="BAClear_Cost">
                    ...
                    <valueEval>
                        <![CDATA[ ( query("/Avg_RS_Empty_Period_Clears") ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( query("/PMUSampleCount/PMUEventType[RS_EVENTS.EMPTY_CYCLES]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[ICACHE.IFETCH_STALL]") >= 10 ) ) && ( query("/PMUSampleCount/PMUEventType[RS_EVENTS.EMPTY_END]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                ...
                <derivedQuery displayName="%Load_Miss_Real_Latency" id="Load_Miss_Real_Latency">
                    ...
                    <valueEval>
                        <![CDATA[ ( query("/PMUEventCount/PMUEventType[L1D_PEND_MISS.PENDING]") / ( query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L1_MISS]") + query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") ) ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( query("/PMUSampleCount/PMUEventType[L1D_PEND_MISS.PENDING]") >= 10 ) && ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L1_MISS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") >= 10 ) ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                ...
                <derivedQuery displayName="%Cycles_0_Ports_Utilized" id="Cycles_0_Ports_Utilized">
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=1]") >= 10 ) && ( ( 2 ) if ( query("/SMT_on") ) else ( ( ( ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") ) >= 10 if ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") ) < ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.CYCLES_NO_EXECUTE]") ) else ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.CYCLES_NO_EXECUTE]") ) >= 10 ) || ( ( ( query("/PMUSampleCount/PMUEventType[RS_EVENTS.EMPTY_CYCLES]") >= 10 ) ) if ( ( query("/FELatency") > 0.1 ) ) else ( 0 ) ) ) ) ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%Cycles_1_Port_Utilized" id="Cycles_1_Port_Utilized">
                    ...
                    <valueEval>
                        <![CDATA[ ( ( query("/PMUEventCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=1]") - query("/PMUEventCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=2]") ) / 2 if query("/SMT_on") else ( query("/PMUEventCount/PMUEventType[UOPS_EXECUTED.CYCLES_GE_1_UOP_EXEC]") - query("/PMUEventCount/PMUEventType[UOPS_EXECUTED.CYCLES_GE_2_UOPS_EXEC]") ) ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=1]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=2]") >= 10 ) ) && ( ( 2 ) if ( query("/SMT_on") ) else ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CYCLES_GE_1_UOP_EXEC]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CYCLES_GE_2_UOPS_EXEC]") >= 10 ) ) ) ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%Cycles_2_Ports_Utilized" id="Cycles_2_Ports_Utilized">
                    ...
                    <valueEval>
                        <![CDATA[ ( ( query("/PMUEventCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=2]") - query("/PMUEventCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=3]") ) / 2 if query("/SMT_on") else ( query("/PMUEventCount/PMUEventType[UOPS_EXECUTED.CYCLES_GE_2_UOPS_EXEC]") - query("/PMUEventCount/PMUEventType[UOPS_EXECUTED.CYCLES_GE_3_UOPS_EXEC]") ) ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=2]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=3]") >= 10 ) ) && ( ( 2 ) if ( query("/SMT_on") ) else ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CYCLES_GE_2_UOPS_EXEC]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CYCLES_GE_3_UOPS_EXEC]") >= 10 ) ) ) ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%Cycles_3m_Ports_Utilized" id="Cycles_3m_Ports_Utilized">
                    ...
                    <valueEval>
                        <![CDATA[ ( ( query("/PMUEventCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=3]") / 2 ) if query("/SMT_on") else query("/PMUEventCount/PMUEventType[UOPS_EXECUTED.CYCLES_GE_3_UOPS_EXEC]") ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=3]") >= 10 )  ) ) if ( query("/SMT_on") ) else ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CYCLES_GE_3_UOPS_EXEC]") >= 10 ) ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%Frontend_Latency_Cycles" id="Frontend_Latency_Cycles">
                    ...
                    <valueEval>
                        <![CDATA[ ( ( query("/PMUEventCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") < query("/PMUEventCount/PMUEventType[IDQ_UOPS_NOT_DELIVERED.CYCLES_0_UOPS_DELIV.CORE]") ? query("/PMUEventCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") : query("/PMUEventCount/PMUEventType[IDQ_UOPS_NOT_DELIVERED.CYCLES_0_UOPS_DELIV.CORE]") ) ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") ) >= 10 if ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") ) < ( query("/PMUSampleCount/PMUEventType[IDQ_UOPS_NOT_DELIVERED.CYCLES_0_UOPS_DELIV.CORE]") ) else ( query("/PMUSampleCount/PMUEventType[IDQ_UOPS_NOT_DELIVERED.CYCLES_0_UOPS_DELIV.CORE]") ) >= 10 ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%STALLS_MEM_ANY" id="STALLS_MEM_ANY">
                    ...
                    <valueEval>
                        <![CDATA[ ( ( query("/PMUEventCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") < query("/PMUEventCount/PMUEventType[CYCLE_ACTIVITY.STALLS_LDM_PENDING]") ? query("/PMUEventCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") : query("/PMUEventCount/PMUEventType[CYCLE_ACTIVITY.STALLS_LDM_PENDING]") ) ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") ) >= 10 if ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") ) < ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.STALLS_LDM_PENDING]") ) else ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.STALLS_LDM_PENDING]") ) >= 10 ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%STALLS_TOTAL" id="STALLS_TOTAL">
                    ...
                    <valueEval>
                        <![CDATA[ ( ( query("/PMUEventCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") < query("/PMUEventCount/PMUEventType[CYCLE_ACTIVITY.CYCLES_NO_EXECUTE]") ? query("/PMUEventCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") : query("/PMUEventCount/PMUEventType[CYCLE_ACTIVITY.CYCLES_NO_EXECUTE]") ) ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") ) >= 10 if ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") ) < ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.CYCLES_NO_EXECUTE]") ) else ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.CYCLES_NO_EXECUTE]") ) >= 10 ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%ORO_DRD_Any_Cycles" id="ORO_DRD_Any_Cycles">
                    ...
                    <valueEval>
                        <![CDATA[ ( ( query("/PMUEventCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") < query("/PMUEventCount/PMUEventType[OFFCORE_REQUESTS_OUTSTANDING.CYCLES_WITH_DATA_RD]") ? query("/PMUEventCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") : query("/PMUEventCount/PMUEventType[OFFCORE_REQUESTS_OUTSTANDING.CYCLES_WITH_DATA_RD]") ) ) ]]></valueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%ORO_DRD_BW_Cycles" id="ORO_DRD_BW_Cycles">
                    ...
                    <valueEval>
                        <![CDATA[ ( ( query("/PMUEventCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") < query("/PMUEventCount/PMUEventType[OFFCORE_REQUESTS_OUTSTANDING.ALL_DATA_RD:cmask=6]") ? query("/PMUEventCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") : query("/PMUEventCount/PMUEventType[OFFCORE_REQUESTS_OUTSTANDING.ALL_DATA_RD:cmask=6]") ) ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") ) >= 10 if ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") ) < ( query("/PMUSampleCount/PMUEventType[OFFCORE_REQUESTS_OUTSTANDING.ALL_DATA_RD:cmask=6]") ) else ( query("/PMUSampleCount/PMUEventType[OFFCORE_REQUESTS_OUTSTANDING.ALL_DATA_RD:cmask=6]") ) >= 10 ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                ...
                <derivedQuery displayName="%Store_L2_Hit_Cycles" id="Store_L2_Hit_Cycles">
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( query("/PMUSampleCount/PMUEventType[L2_RQSTS.RFO_HIT]") >= 10 )  ) || (  ( ( query("/PMUSampleCount/PMUEventType[MEM_UOPS_RETIRED.LOCK_LOADS_PS]") >= 10 ) && ( query("/PMUSampleCount/PMUEventType[MEM_UOPS_RETIRED.ALL_STORES_PS]") >= 10 ) ) ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%LOAD_L1_MISS" id="LOAD_L1_MISS">
                    ...
                    <valueEval>
                        <![CDATA[ ( query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L2_HIT_PS]") + query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") + query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]") + query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") + query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_MISS_PS]") + 1 ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L2_HIT_PS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_MISS_PS]") >= 10 ) )  ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%LOAD_L1_MISS_NET" id="LOAD_L1_MISS_NET">
                    ...
                    <valueEval>
                        <![CDATA[ ( query("/LOAD_L1_MISS") + query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.LOCAL_DRAM]") + query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_DRAM]") + query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_HITM]") + query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_FWD]") ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( ( ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L2_HIT_PS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_MISS_PS]") >= 10 ) )  ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.LOCAL_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_HITM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_FWD]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%LOAD_L3_HIT" id="LOAD_L3_HIT">
                    ...
                    <valueEval>
                        <![CDATA[ ( query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") * ( 1 + query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") / query("/LOAD_L1_MISS_NET") ) + 1 ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) || (  ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") >= 10 ) && ( ( ( ( ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L2_HIT_PS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_MISS_PS]") >= 10 ) )  ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.LOCAL_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_HITM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_FWD]") >= 10 ) ) ) ) )  ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%LOAD_XSNP_HIT" id="LOAD_XSNP_HIT">
                    ...
                    <valueEval>
                        <![CDATA[ ( query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]") * ( 1 + query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") / query("/LOAD_L1_MISS_NET") ) ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]") >= 10 ) || (  ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") >= 10 ) && ( ( ( ( ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L2_HIT_PS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_MISS_PS]") >= 10 ) )  ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.LOCAL_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_HITM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_FWD]") >= 10 ) ) ) ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%LOAD_XSNP_HITM" id="LOAD_XSNP_HITM">
                    ...
                    <valueEval>
                        <![CDATA[ ( query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") * ( 1 + query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") / query("/LOAD_L1_MISS_NET") ) ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") >= 10 ) || (  ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") >= 10 ) && ( ( ( ( ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L2_HIT_PS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_MISS_PS]") >= 10 ) )  ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.LOCAL_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_HITM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_FWD]") >= 10 ) ) ) ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%LOAD_XSNP_MISS" id="LOAD_XSNP_MISS">
                    ...
                    <valueEval>
                        <![CDATA[ ( query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_MISS_PS]") * ( 1 + query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") / query("/LOAD_L1_MISS_NET") ) ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_MISS_PS]") >= 10 ) || (  ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") >= 10 ) && ( ( ( ( ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L2_HIT_PS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_MISS_PS]") >= 10 ) )  ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.LOCAL_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_HITM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_FWD]") >= 10 ) ) ) ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%LOAD_LCL_MEM" id="LOAD_LCL_MEM">
                    ...
                    <valueEval>
                        <![CDATA[ ( query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.LOCAL_DRAM]") * ( 1 + query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") / query("/LOAD_L1_MISS_NET") ) ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.LOCAL_DRAM]") >= 10 ) || (  ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") >= 10 ) && ( ( ( ( ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L2_HIT_PS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_MISS_PS]") >= 10 ) )  ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.LOCAL_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_HITM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_FWD]") >= 10 ) ) ) ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%LOAD_RMT_MEM" id="LOAD_RMT_MEM">
                    ...
                    <valueEval>
                        <![CDATA[ ( query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_DRAM]") * ( 1 + query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") / query("/LOAD_L1_MISS_NET") ) ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_DRAM]") >= 10 ) || (  ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") >= 10 ) && ( ( ( ( ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L2_HIT_PS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_MISS_PS]") >= 10 ) )  ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.LOCAL_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_HITM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_FWD]") >= 10 ) ) ) ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%LOAD_RMT_HITM" id="LOAD_RMT_HITM">
                    ...
                    <valueEval>
                        <![CDATA[ ( query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_HITM]") * ( 1 + query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") / query("/LOAD_L1_MISS_NET") ) ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_HITM]") >= 10 ) || (  ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") >= 10 ) && ( ( ( ( ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L2_HIT_PS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_MISS_PS]") >= 10 ) )  ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.LOCAL_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_HITM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_FWD]") >= 10 ) ) ) ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%LOAD_RMT_FWD" id="LOAD_RMT_FWD">
                    ...
                    <valueEval>
                        <![CDATA[ ( query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_FWD]") * ( 1 + query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") / query("/LOAD_L1_MISS_NET") ) ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_FWD]") >= 10 ) || (  ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") >= 10 ) && ( ( ( ( ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L2_HIT_PS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_MISS_PS]") >= 10 ) )  ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.LOCAL_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_DRAM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_HITM]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_FWD]") >= 10 ) ) ) ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                ...
                <derivedQuery displayName="%Backend_Bound_Cycles" id="Backend_Bound_Cycles">
                    ...
                    <valueEval>
                        <![CDATA[ ( ( query("/STALLS_TOTAL") + query("/PMUEventCount/PMUEventType[UOPS_EXECUTED.CYCLES_GE_1_UOP_EXEC]") - query("/Few_Uops_Executed_Threshold") - query("/Frontend_RS_Empty_Cycles") + query("/PMUEventCount/PMUEventType[RESOURCE_STALLS.SB]") ) ) ]]></valueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%Mem_L3_Hit_Fraction" id="Mem_L3_Hit_Fraction">
                    ...
                    <valueEval>
                        <![CDATA[ ( query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") / ( query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") + query("/Mem_L3_Weight") * query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_MISS_PS]") ) ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) && ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) || (  ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_MISS_PS]") >= 10 ) ) ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                ...
                <derivedQuery displayName="%Avg_RS_Empty_Period_Clears" id="Avg_RS_Empty_Period_Clears">
                    ...
                    <valueEval>
                        <![CDATA[ ( ( query("/PMUEventCount/PMUEventType[RS_EVENTS.EMPTY_CYCLES]") - query("/PMUEventCount/PMUEventType[ICACHE.IFETCH_STALL]") ) / query("/PMUEventCount/PMUEventType[RS_EVENTS.EMPTY_END]") ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( query("/PMUSampleCount/PMUEventType[RS_EVENTS.EMPTY_CYCLES]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[ICACHE.IFETCH_STALL]") >= 10 ) ) && ( query("/PMUSampleCount/PMUEventType[RS_EVENTS.EMPTY_END]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                                                    ...
                                                    <derivedQuery id="locatorStoresBoundGroup">
                                                        ...
                                                        <expand>
                                                            <vectorQuery id="locatorStoresBoundGroupExpanded">
                                                                <derivedQuery id="locatorStoreLatencyGroup">
                                                                    <queryInherit>/locatorStoreLatency</queryInherit>
                                                                    <displayAttributes>
                                                                        <boolean:expand>false</boolean:expand>
                                                                        <boolean:allowCollapse>true</boolean:allowCollapse>
                                                                    </displayAttributes>
                                                                    <expand>
                                                                        <vectorQuery id="locatorStoreLatencyGroupExpanded" />
                                                                    </expand>
                                                                </derivedQuery>
            ...
            <locatorqueryLibrary>
                <derivedQuery displayName="%RetiredPipelineSlots" id="locatorRetiredPipelineSlots">
                    ...
                    <helpKeyword>configs.retiredpipelineslots_retiredpipelineslotsdescriptionall</helpKeyword>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( query("/PMUSampleCount/PMUEventType[UOPS_RETIRED.RETIRE_SLOTS]") >= 10 ) )) ]]></confidenceEval>
                    <valueEval>
                ...
                <derivedQuery displayName="%FELatency" id="locatorFELatency">
                    ...
                    <helpKeyword>configs.felatency_felatencydescriptionall</helpKeyword>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( query("/PMUSampleCount/PMUEventType[RS_EVENTS.EMPTY_END]") >= 10 ) )) ]]></confidenceEval>
                    <valueEval>
                ...
                <derivedQuery displayName="%ITLBOverhead" id="locatorITLBOverhead">
                    ...
                    <helpKeyword>configs.itlboverhead_itlboverheaddescriptionall</helpKeyword>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( query("/PMUSampleCount/PMUEventType[ITLB_MISSES.WALK_COMPLETED]") >= 10 ) )) ]]></confidenceEval>
                    <valueEval>
                ...
                <derivedQuery displayName="%MemBound" id="locatorMemBound">
                    ...
                    <helpKeyword>configs.membound_membounddescriptionall</helpKeyword>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.STALLS_LDM_PENDING]") >= 10 ) )) ]]></confidenceEval>
                    <valueEval>
                ...
                <derivedQuery displayName="%L1Bound" id="locatorL1Bound">
                    ...
                    <helpKeyword>configs.l1bound_l1bounddescriptionall</helpKeyword>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L1_HIT_PS]") >= 10 ) )) ]]></confidenceEval>
                    <valueEval>
                ...
                <derivedQuery displayName="%DTLBOverhead" id="locatorDTLBOverhead">
                    ...
                    <helpKeyword>configs.dtlboverhead_dtlboverheaddescriptionall</helpKeyword>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( query("/PMUSampleCount/PMUEventType[MEM_UOPS_RETIRED.STLB_MISS_LOADS_PS]") >= 10 ) )) ]]></confidenceEval>
                    <valueEval>
                ...
                <derivedQuery displayName="%LockLatency" id="locatorLockLatency">
                    ...
                    <helpKeyword>configs.locklatency_locklatencydescriptionall</helpKeyword>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( query("/PMUSampleCount/PMUEventType[MEM_UOPS_RETIRED.LOCK_LOADS_PS]") >= 10 ) )) ]]></confidenceEval>
                    <valueEval>
                ...
                <derivedQuery displayName="%SplitLoads" id="locatorSplitLoads">
                    ...
                    <helpKeyword>configs.splitloads_splitloadsdescriptionall</helpKeyword>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( query("/PMUSampleCount/PMUEventType[MEM_UOPS_RETIRED.SPLIT_LOADS_PS]") >= 10 ) )) ]]></confidenceEval>
                    <valueEval>
                ...
                <derivedQuery displayName="%4KAliasing" id="locator4KAliasing">
                    ...
                    <issueText>%4KAliasingIssueTextAll</issueText>
                    <issueEval>
                        <![CDATA[ ( ( query("/locator4KAliasing") > 0.7 ) ) ]]></issueEval>
                </derivedQuery>
                ...
                <derivedQuery displayName="%L2Bound" id="locatorL2Bound">
                    ...
                    <helpKeyword>configs.l2bound_l2bounddescriptionall</helpKeyword>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L2_HIT_PS]") >= 10 ) )) ]]></confidenceEval>
                    <valueEval>
                ...
                <derivedQuery displayName="%L3Bound" id="locatorL3Bound">
                    ...
                    <helpKeyword>configs.l3bound_l3bounddescriptionall</helpKeyword>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) )) ]]></confidenceEval>
                    <valueEval>
                ...
                <derivedQuery displayName="%ContestedAccesses" id="locatorContestedAccesses">
                    ...
                    <helpKeyword>configs.contestedaccesses_contestedaccessesdescriptionall</helpKeyword>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") >= 10 ) )) ]]></confidenceEval>
                    <valueEval>
                        <![CDATA[ ( (query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") / queryAll("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]", true)) * queryAll("/ContestedAccesses", true) ) ]]></valueEval>
                    <issueText>%ContestedAccessesIssueTextAll</issueText>
                    <issueEval>
                ...
                <derivedQuery displayName="%DataSharing" id="locatorDataSharing">
                    ...
                    <helpKeyword>configs.datasharing_datasharingdescriptionall</helpKeyword>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]") >= 10 ) )) ]]></confidenceEval>
                    <valueEval>
                        <![CDATA[ ( (query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]") / queryAll("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]", true)) * queryAll("/DataSharing", true) ) ]]></valueEval>
                    <issueText>%DataSharingIssueTextAll</issueText>
                    <issueEval>
                ...
                <derivedQuery displayName="%L3Latency" id="locatorL3Latency">
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) )) ]]></confidenceEval>
                    <valueEval>
                        <![CDATA[ ( (query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") / queryAll("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]", true)) * queryAll("/L3Latency", true) ) ]]></valueEval>
                    <issueText>%L3LatencyIssueTextAll</issueText>
                    <issueEval>
                ...
                <derivedQuery displayName="%DRAMBound" id="locatorDRAMBound">
                    ...
                    <helpKeyword>configs.drambound_drambounddescriptionall</helpKeyword>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_MISS_PS]") >= 10 ) )) ]]></confidenceEval>
                    <valueEval>
                        <![CDATA[ ( (query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_MISS_PS]") / queryAll("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_MISS_PS]", true)) * queryAll("/DRAMBound", true) ) ]]></valueEval>
                    <issueText>%DRAMBoundIssueTextAll</issueText>
                    <issueEval>
                ...
                <derivedQuery displayName="%LocalDRAM" id="locatorLocalDRAM">
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_MISS_PS]") >= 10 ) )) ]]></confidenceEval>
                    <valueEval>
                        <![CDATA[ ( (query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_MISS_PS]") / queryAll("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_MISS_PS]", true)) * queryAll("/LocalDRAM", true) ) ]]></valueEval>
                    <issueText>%LocalDRAMIssueTextAll</issueText>
                    <issueEval>
                ...
                <derivedQuery displayName="%RemoteDRAM" id="locatorRemoteDRAM">
                    ...
                    <helpKeyword>configs.remotedram_remotedramdescriptionall</helpKeyword>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_DRAM]") >= 10 ) )) ]]></confidenceEval>
                    <valueEval>
                        <![CDATA[ ( (query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_DRAM]") / queryAll("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_DRAM]", true)) * queryAll("/RemoteDRAM", true) ) ]]></valueEval>
                    <issueText>%RemoteDRAMIssueTextAll</issueText>
                    <issueEval>
                ...
                <derivedQuery displayName="%RemoteCache" id="locatorRemoteCache">
                    ...
                    <helpKeyword>configs.remotecache_remotecachedescriptionall</helpKeyword>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_HITM]") >= 10 ) )) ]]></confidenceEval>
                    <valueEval>
                        <![CDATA[ ( (query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_HITM]") / queryAll("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_LLC_MISS_RETIRED.REMOTE_HITM]", true)) * queryAll("/RemoteCache", true) ) ]]></valueEval>
                    <issueText>%RemoteCacheIssueTextAll</issueText>
                    <issueEval>
                ...
                <derivedQuery displayName="%StoresBound" id="locatorStoresBound">
                    ...
                    <helpKeyword>configs.storesbound_storesbounddescriptionall</helpKeyword>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( query("/PMUSampleCount/PMUEventType[MEM_UOPS_RETIRED.ALL_STORES_PS]") >= 10 ) )) ]]></confidenceEval>
                    <valueEval>
                ...
                <derivedQuery displayName="%FalseSharing" id="locatorFalseSharing">
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") >= 10 ) )) ]]></confidenceEval>
                    <valueEval>
                        <![CDATA[ ( (query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") / queryAll("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]", true)) * queryAll("/FalseSharing", true) ) ]]></valueEval>
                    <issueText>%FalseSharingIssueTextAll</issueText>
                    <issueEval>
                ...
                <derivedQuery displayName="%SplitStores" id="locatorSplitStores">
                    ...
                    <helpKeyword>configs.splitstores_splitstoresdescriptionall</helpKeyword>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( query("/PMUSampleCount/PMUEventType[MEM_UOPS_RETIRED.SPLIT_STORES_PS]") >= 10 ) )) ]]></confidenceEval>
                    <valueEval>
                ...
                <derivedQuery displayName="%DTLBStoreOverhead" id="locatorDTLBStoreOverhead">
                    ...
                    <helpKeyword>configs.dtlbstoreoverhead_dtlbstoreoverheaddescriptionall</helpKeyword>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( query("/PMUSampleCount/PMUEventType[MEM_UOPS_RETIRED.STLB_MISS_STORES_PS]") >= 10 ) )) ]]></confidenceEval>
                    <valueEval>
                ...
                <derivedQuery displayName="%DIVActive" id="locatorDIVActive">
                    ...
                    <helpKeyword>configs.divactive_divactivedescriptionall</helpKeyword>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( query("/PMUSampleCount/PMUEventType[ARITH.FPU_DIV_ACTIVE]") >= 10 ) )) ]]></confidenceEval>
                    <valueEval>
