        ...
        <bag>
            ...
            <queryLibrary>
                ...
                <derivedQuery displayName="%FBFull" id="FBFull">
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <issueEval>
                                <![CDATA[ ( ( ( query("/FBFull") > 0.3 ) || ( queryOptional("/SQFull") > 0.3) || ( queryOptional("/StoreLatency") > 0.1) ) && ( ( ( ( query("/L1Bound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) || ( queryOptional("/DTLBOverhead") > 0.1 ) || ( queryOptional("/Cycles1PortUtilized") > 0.2) && ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                        </xsl:otherwise>
                    </xsl:choose>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( ( query("/PMUSampleCount/PMUEventType[L1D_PEND_MISS.PENDING]") >= 10 ) && ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L1_MISS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") >= 10 ) ) ) || ( query("/PMUSampleCount/PMUEventType[L1D_PEND_MISS.REQUEST_FB_FULL:cmask=1]") >= 10 ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                ...
                <derivedQuery displayName="%L3Bound" id="L3Bound">
                    <xsl:choose>
                        <xsl:when test="not( $isHTOn )">
                            ...
                            <confidenceEval>
                                <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L3_HIT_PS]") >= 10 ) && ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L3_HIT_PS]") >= 10 ) || (  ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L3_MISS_PS]") >= 10 ) ) ) ) || ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.STALLS_L2_PENDING]") >= 10 ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                        </xsl:when>
                        <xsl:otherwise>
                            <queryInherit>/GeMetricNA</queryInherit>
                        </xsl:otherwise>
                ...
                <derivedQuery displayName="%ContestedAccesses" id="ContestedAccesses">
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <issueEval>
                                <![CDATA[ ( ( ( ( query("/ContestedAccesses") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) || ( queryOptional("/FalseSharing") > 0.1) ) && ( ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                        </xsl:otherwise>
                    </xsl:choose>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%DataSharing" id="DataSharing">
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <issueEval>
                                <![CDATA[ ( ( ( ( query("/DataSharing") > 0.2 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                        </xsl:otherwise>
                    </xsl:choose>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%L3Latency" id="L3Latency">
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <issueEval>
                                <![CDATA[ ( ( ( ( query("/L3Latency") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                        </xsl:otherwise>
                    </xsl:choose>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%SQFull" id="SQFull">
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <issueEval>
                                <![CDATA[ ( ( ( ( query("/SQFull") > 0.3 ) && ( query("/PMUHotspot") > 0.05 ) ) || ( queryOptional("/FBFull") > 0.3) ) && ( ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                        </xsl:otherwise>
                    </xsl:choose>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%LocalDRAM" id="LocalDRAM">
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <issueEval>
                                <![CDATA[ ( ( ( ( query("/LocalDRAM") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                        </xsl:otherwise>
                    </xsl:choose>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%RemoteDRAM" id="RemoteDRAM">
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <issueEval>
                                <![CDATA[ ( ( ( ( query("/RemoteDRAM") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                        </xsl:otherwise>
                    </xsl:choose>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%RemoteCache" id="RemoteCache">
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <issueEval>
                                <![CDATA[ ( ( ( ( query("/RemoteCache") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                        </xsl:otherwise>
                    </xsl:choose>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%DIVActive" id="DIVActive">
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( (  ( query("/PMUSampleCount/PMUEventType[ARITH.DIVIDER_UOPS]") >= 10 ) ) && ( query("/ClocktickSamples") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                ...
                <derivedQuery displayName="%Cycles1PortUtilized" id="Cycles1PortUtilized">
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=1]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=2]") >= 10 ) ) && ( ( 2 ) if ( query("/SMT_on") ) else ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=1]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=2]") >= 10 ) ) ) ) ) && ( query("/ClocktickSamples") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%Cycles2PortsUtilized" id="Cycles2PortsUtilized">
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=2]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=3]") >= 10 ) ) && ( ( 2 ) if ( query("/SMT_on") ) else ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=2]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=3]") >= 10 ) ) ) ) ) && ( query("/ClocktickSamples") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%Cycles3mPortsUtilized" id="Cycles3mPortsUtilized">
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=3]") >= 10 )  ) ) if ( query("/SMT_on") ) else ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=3]") >= 10 ) ) ) && ( query("/ClocktickSamples") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                ...
                <derivedQuery displayName="%Cycles_1_Port_Utilized" id="Cycles_1_Port_Utilized">
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=1]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=2]") >= 10 ) ) && ( ( 2 ) if ( query("/SMT_on") ) else ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=1]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=2]") >= 10 ) ) ) ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%Cycles_2_Ports_Utilized" id="Cycles_2_Ports_Utilized">
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=2]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=3]") >= 10 ) ) && ( ( 2 ) if ( query("/SMT_on") ) else ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=2]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=3]") >= 10 ) ) ) ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%Cycles_3m_Ports_Utilized" id="Cycles_3m_Ports_Utilized">
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=3]") >= 10 )  ) ) if ( query("/SMT_on") ) else ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=3]") >= 10 ) ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                ...
                <derivedQuery displayName="%Few_Uops_Executed_Threshold" id="Few_Uops_Executed_Threshold">
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=3]") >= 10 ) ) if ( ( query("/IPC") > 1.8 ) ) else ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=2]") >= 10 ) ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                <derivedQuery displayName="%Backend_Bound_Cycles" id="Backend_Bound_Cycles">
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") ) >= 10 if ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") ) < ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.CYCLES_NO_EXECUTE]") ) else ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.CYCLES_NO_EXECUTE]") ) >= 10 ) || ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=1]") >= 10 ) || ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=3]") >= 10 ) ) if ( ( query("/IPC") > 1.8 ) ) else ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=2]") >= 10 ) ) ) )  ) ) || ( ( ( query("/PMUSampleCount/PMUEventType[RS_EVENTS.EMPTY_CYCLES]") >= 10 ) ) if ( ( query("/FELatency") > 0.1 ) ) else ( 0 ) ) ) || ( query("/PMUSampleCount/PMUEventType[RESOURCE_STALLS.SB]") >= 10 ) ) ) if ( query("/SMT_on") ) else ( ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") ) >= 10 if ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") ) < ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.CYCLES_NO_EXECUTE]") ) else ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.CYCLES_NO_EXECUTE]") ) >= 10 ) || ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=1]") >= 10 ) ) || ( ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=3]") >= 10 ) ) if ( ( query("/IPC") > 1.8 ) ) else ( ( query("/PMUSampleCount/PMUEventType[UOPS_EXECUTED.CORE:cmask=2]") >= 10 ) ) ) ) || ( ( ( query("/PMUSampleCount/PMUEventType[RS_EVENTS.EMPTY_CYCLES]") >= 10 ) ) if ( ( query("/FELatency") > 0.1 ) ) else ( 0 ) ) ) || ( query("/PMUSampleCount/PMUEventType[RESOURCE_STALLS.SB]") >= 10 ) ) ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
            ...
            <locatorqueryLibrary>
                ...
                <derivedQuery displayName="%DIVActive" id="locatorDIVActive">
                    ...
                    <helpKeyword>configs.divactive_divactivedescriptionall</helpKeyword>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( query("/PMUSampleCount/PMUEventType[ARITH.DIVIDER_UOPS]") >= 10 ) )) ]]></confidenceEval>
                    <valueEval>
