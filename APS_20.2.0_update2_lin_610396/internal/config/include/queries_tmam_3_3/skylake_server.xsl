        ...
        <bag>
            ...
            <queryLibrary>
                ...
                <derivedQuery displayName="%BranchResteers" id="BranchResteers">
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( query("/PMUSampleCount/PMUEventType[INT_MISC.CLEAR_RESTEER_CYCLES]") >= 10 ) || ( ( ( ( ( query("/PMUSampleCount/PMUEventType[RS_EVENTS.EMPTY_CYCLES]") >= 10 ) || ( ( query("/PMUSampleCount/PMUEventType[ICACHE_16B.IFDATA_STALL]") >= 10 ) || (  ( query("/PMUSampleCount/PMUEventType[ICACHE_16B.IFDATA_STALL:cmask=1:e=yes]") >= 10 ) ) ) ) || ( query("/PMUSampleCount/PMUEventType[ICACHE_64B.IFTAG_STALL]") >= 10 ) ) && ( query("/PMUSampleCount/PMUEventType[RS_EVENTS.EMPTY_END]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[BACLEARS.ANY]") >= 10 ) ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                ...
                <derivedQuery displayName="%Unknown_Branches" id="Unknown_Branches">
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( ( query("/PMUSampleCount/PMUEventType[INT_MISC.CLEAR_RESTEER_CYCLES]") >= 10 ) || ( ( ( ( ( query("/PMUSampleCount/PMUEventType[RS_EVENTS.EMPTY_CYCLES]") >= 10 ) || ( ( query("/PMUSampleCount/PMUEventType[ICACHE_16B.IFDATA_STALL]") >= 10 ) || (  ( query("/PMUSampleCount/PMUEventType[ICACHE_16B.IFDATA_STALL:cmask=1:e=yes]") >= 10 ) ) ) ) || ( query("/PMUSampleCount/PMUEventType[ICACHE_64B.IFTAG_STALL]") >= 10 ) ) && ( query("/PMUSampleCount/PMUEventType[RS_EVENTS.EMPTY_END]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[BACLEARS.ANY]") >= 10 ) ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) || ( ( query("/PMUSampleCount/PMUEventType[INT_MISC.CLEAR_RESTEER_CYCLES]") >= 10 ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                ...
                <derivedQuery displayName="%L2Bound" id="L2Bound">
                    ...
                    <valueEval>
                        <![CDATA[ ( ( 1 if query("/FBFull") < 1.5 else query("/LOAD_L2_HIT") / ( query("/LOAD_L2_HIT") + query("/PMUEventCount/PMUEventType[L1D_PEND_MISS.FB_FULL:cmask=1]") ) ) * query("/L2_Bound_Fraction") ) ]]></valueEval>
                ...
                <derivedQuery displayName="%L3Bound" id="L3Bound">
                    ...
                    <valueEval>
                        <![CDATA[ ( ( 1 - query("/L4_Hit_Fraction") ) * ( query("/PMUEventCount/PMUEventType[CYCLE_ACTIVITY.STALLS_L2_MISS]") - query("/PMUEventCount/PMUEventType[CYCLE_ACTIVITY.STALLS_L3_MISS]") ) / query("/DerivedClockticks") if query("/L4_Cache") else ( query("/PMUEventCount/PMUEventType[CYCLE_ACTIVITY.STALLS_L2_MISS]") - query("/PMUEventCount/PMUEventType[CYCLE_ACTIVITY.STALLS_L3_MISS]") ) / query("/DerivedClockticks") ) ]]></valueEval>
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( (  ( ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.STALLS_L2_MISS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.STALLS_L3_MISS]") >= 10 ) ) ) && ( ( ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) if ( query("/L4_Cache") ) else ( ( ( ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.STALLS_L2_MISS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[CYCLE_ACTIVITY.STALLS_L3_MISS]") >= 10 ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                ...
                <derivedQuery displayName="%DRAMBound" id="DRAMBound">
                    ...
                    <valueEval>
                        <![CDATA[ ( query("/PMUEventCount/PMUEventType[CYCLE_ACTIVITY.STALLS_L3_MISS]") / query("/DerivedClockticks") + query("/L2_Bound_Fraction") - query("/L2Bound") ) ]]></valueEval>
                ...
                <derivedQuery displayName="%Store_L3" id="Store_L3">
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( query("/PMUSampleCount/PMUEventType[OFFCORE_RESPONSE:request=DEMAND_RFO:response=L3_HIT.ANY_SNOOP]") >= 10 ) && ( ( (  ( query("/PMUSampleCount/PMUEventType[OFFCORE_RESPONSE:request=DEMAND_RFO:response=L3_MISS.ANY_SNOOP]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[OFFCORE_RESPONSE:request=DEMAND_RFO:response=L3_HIT.ANY_SNOOP]") >= 10 ) )  ) ) || ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[L2_RQSTS.RFO_HIT]") >= 10 )  ) || (  ( ( query("/PMUSampleCount/PMUEventType[MEM_INST_RETIRED.LOCK_LOADS_PS]") >= 10 ) && ( query("/PMUSampleCount/PMUEventType[MEM_INST_RETIRED.ALL_STORES_PS]") >= 10 ) ) ) ) || ( (  ( ( query("/PMUSampleCount/PMUEventType[MEM_INST_RETIRED.LOCK_LOADS_PS]") >= 10 ) && ( query("/PMUSampleCount/PMUEventType[MEM_INST_RETIRED.ALL_STORES_PS]") >= 10 ) ) ) || ( ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") ) >= 10 if ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") ) < ( query("/PMUSampleCount/PMUEventType[OFFCORE_REQUESTS_OUTSTANDING.CYCLES_WITH_DEMAND_RFO]") ) else ( query("/PMUSampleCount/PMUEventType[OFFCORE_REQUESTS_OUTSTANDING.CYCLES_WITH_DEMAND_RFO]") ) >= 10 ) ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) || ( ( ( ( query("/PMUSampleCount/PMUEventType[L2_RQSTS.RFO_HIT]") >= 10 )  ) || (  ( ( query("/PMUSampleCount/PMUEventType[MEM_INST_RETIRED.LOCK_LOADS_PS]") >= 10 ) && ( query("/PMUSampleCount/PMUEventType[MEM_INST_RETIRED.ALL_STORES_PS]") >= 10 ) ) ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                ...
                <derivedQuery displayName="%PortUtil" id="PortUtil">
                    ...
                    <valueEval>
                        <![CDATA[ ( ( query("/Backend_Bound_Cycles") - query("/PMUEventCount/PMUEventType[CYCLE_ACTIVITY.STALLS_MEM_ANY]") - query("/PMUEventCount/PMUEventType[EXE_ACTIVITY.BOUND_ON_STORES]") ) / query("/DerivedClockticks") ) ]]></valueEval>
                ...
                <derivedQuery displayName="%BAClear_Cost" id="BAClear_Cost">
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( ( query("/PMUSampleCount/PMUEventType[RS_EVENTS.EMPTY_CYCLES]") >= 10 ) || ( ( query("/PMUSampleCount/PMUEventType[ICACHE_16B.IFDATA_STALL]") >= 10 ) || (  ( query("/PMUSampleCount/PMUEventType[ICACHE_16B.IFDATA_STALL:cmask=1:e=yes]") >= 10 ) ) ) ) || ( query("/PMUSampleCount/PMUEventType[ICACHE_64B.IFTAG_STALL]") >= 10 ) ) && ( query("/PMUSampleCount/PMUEventType[RS_EVENTS.EMPTY_END]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                ...
                <derivedQuery displayName="%Load_Miss_Real_Latency" id="Load_Miss_Real_Latency">
                    ...
                    <valueEval>
                        <![CDATA[ ( query("/PMUEventCount/PMUEventType[L1D_PEND_MISS.PENDING]") / ( query("/PMUEventCount/PMUEventType[MEM_LOAD_RETIRED.L1_MISS_PS]") + query("/PMUEventCount/PMUEventType[MEM_LOAD_RETIRED.FB_HIT_PS]") ) ) ]]></valueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%L2_Bound_Fraction" id="L2_Bound_Fraction">
                    ...
                    <helpKeyword>configs.l2_bound_fraction_l2_bound_fractiondescriptionall</helpKeyword>
                    <valueEval>
                ...
                <derivedQuery displayName="%RFO_L3_Hit_Fraction" id="RFO_L3_Hit_Fraction">
                    ...
                    <valueEval>
                        <![CDATA[ ( query("/PMUEventCount/PMUEventType[OFFCORE_RESPONSE:request=DEMAND_RFO:response=L3_HIT.ANY_SNOOP]") / ( 7 * query("/PMUEventCount/PMUEventType[OFFCORE_RESPONSE:request=DEMAND_RFO:response=L3_MISS.ANY_SNOOP]") + query("/PMUEventCount/PMUEventType[OFFCORE_RESPONSE:request=DEMAND_RFO:response=L3_HIT.ANY_SNOOP]") + 1 ) ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( query("/PMUSampleCount/PMUEventType[OFFCORE_RESPONSE:request=DEMAND_RFO:response=L3_HIT.ANY_SNOOP]") >= 10 ) && ( ( (  ( query("/PMUSampleCount/PMUEventType[OFFCORE_RESPONSE:request=DEMAND_RFO:response=L3_MISS.ANY_SNOOP]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[OFFCORE_RESPONSE:request=DEMAND_RFO:response=L3_HIT.ANY_SNOOP]") >= 10 ) )  ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                ...
                <derivedQuery displayName="%L4_Hit_Fraction" id="L4_Hit_Fraction">
                    <queryInherit>/GeMetricBasePercentageNotClockticks</queryInherit>
                    <description>%L4_Hit_FractionDescriptionAll</description>
                    <helpKeyword>configs.l4_hit_fraction_l4_hit_fractiondescriptionall</helpKeyword>
                    <valueEval>
                        <![CDATA[ ( 0 ) ]]></valueEval>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%Avg_RS_Empty_Period_Clears" id="Avg_RS_Empty_Period_Clears">
                    ...
                    <valueEval>
                        <![CDATA[ ( ( query("/PMUEventCount/PMUEventType[RS_EVENTS.EMPTY_CYCLES]") - ( query("/PMUEventCount/PMUEventType[ICACHE_16B.IFDATA_STALL]") + 2 * query("/PMUEventCount/PMUEventType[ICACHE_16B.IFDATA_STALL:cmask=1:e=yes]") ) - query("/PMUEventCount/PMUEventType[ICACHE_64B.IFTAG_STALL]") ) / query("/PMUEventCount/PMUEventType[RS_EVENTS.EMPTY_END]") ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( ( ( ( query("/PMUSampleCount/PMUEventType[RS_EVENTS.EMPTY_CYCLES]") >= 10 ) || ( ( query("/PMUSampleCount/PMUEventType[ICACHE_16B.IFDATA_STALL]") >= 10 ) || (  ( query("/PMUSampleCount/PMUEventType[ICACHE_16B.IFDATA_STALL:cmask=1:e=yes]") >= 10 ) ) ) ) || ( query("/PMUSampleCount/PMUEventType[ICACHE_64B.IFTAG_STALL]") >= 10 ) ) && ( query("/PMUSampleCount/PMUEventType[RS_EVENTS.EMPTY_END]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                ...
                <derivedQuery displayName="%L4_Cache" id="L4_Cache">
                    <queryInherit>/GeMetricBasePercentageNotClockticks</queryInherit>
                    <description>%L4_CacheDescriptionAll</description>
                    <helpKeyword>configs.l4_cache_l4_cachedescriptionall</helpKeyword>
                    <valueEval>
                        <![CDATA[ ( 0 ) ]]></valueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
