            ...
            <queryLibrary>
                ...
                <derivedQuery displayName="%LLCMiss" id="LLCMiss">
                    ...
                    <xsl:choose>
                        ...
                        <xsl:otherwise>
                            <issueEval>
                                <![CDATA[ ( ( ( ( query("/LLCMiss") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                        </xsl:otherwise>
                    </xsl:choose>
                    <confidenceEval>
                ...
                <derivedQuery displayName="%FalseSharing" id="FalseSharing">
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( (  ( query("/PMUSampleCount/PMUEventType[OFFCORE_RESPONSE:request=DEMAND_RFO:response=L3_HIT.HITM_OTHER_CORE]") >= 10 ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
