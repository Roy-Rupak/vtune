        ...
        <bag>
            ...
            <queryLibrary>
                ...
                <derivedQuery displayName="%ContestedAccesses" id="ContestedAccesses">
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( (  ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") >= 10 ) || (  ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") >= 10 ) && ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L2_HIT_PS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_MISS_PS]") >= 10 ) )  ) ) ) ) || ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_MISS_PS]") >= 10 ) || (  ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.HIT_LFB_PS]") >= 10 ) && ( ( ( ( ( ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.L2_HIT_PS]") >= 10 ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HIT_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_HITM_PS]") >= 10 ) ) || ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_LLC_HIT_RETIRED.XSNP_MISS_PS]") >= 10 ) )  ) ) ) ) ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                ...
                <derivedQuery displayName="%LLCMiss" id="LLCMiss">
                    ...
                    <valueEval>
                        <![CDATA[ ( ( 130 * query("/PMUEventCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_MISS_PS]") ) / query("/DerivedClockticks") ) ]]></valueEval>
                    <issueText>%LLCMissIssueTextAll</issueText>
                    <issueEval>
                        <![CDATA[ ( ( ( ( query("/LLCMiss") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) ) && ( ( ( query("/MEMLatency") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/DRAMBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( ( query("/MemBound") > 0.1 ) && ( query("/PMUHotspot") > 0.05 ) ) && ( query("/BackendBound") > 0.2 ) ) ) ]]></issueEval>
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( (  ( query("/PMUSampleCount/PMUEventType[MEM_LOAD_UOPS_RETIRED.LLC_MISS_PS]") >= 10 ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
                ...
                <derivedQuery displayName="%FalseSharing" id="FalseSharing">
                    ...
                    <valueEval>
                        <![CDATA[ ( query("/Mem_XSNP_HitM_Cost") * query("/PMUEventCount/PMUEventType[OFFCORE_RESPONSE.DEMAND_RFO.LLC_HIT.HITM_OTHER_CORE_0]") / query("/DerivedClockticks") ) ]]></valueEval>
                    ...
                    <confidenceEval>
                        <![CDATA[ ( ( $useCountingMode ? $TRUE : ( ( (  ( query("/PMUSampleCount/PMUEventType[OFFCORE_RESPONSE.DEMAND_RFO.LLC_HIT.HITM_OTHER_CORE_0]") >= 10 ) ) && ( query("/PMUSampleCount/PMUEventType[CPU_CLK_UNHALTED.THREAD]") >= 10 ) ) ) ) && ( query("/Reliability") >= 0.5 )) ]]></confidenceEval>
                </derivedQuery>
